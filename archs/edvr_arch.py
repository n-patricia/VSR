...
from archs.arch_util import DeformConv2d, ResidualBlockNoBN, make_layer
...
class PCDAlignment(nn.Module):
    def __init__(self, num_feat=64, deformable_groups=8):
        ...
        for i in range(3, 0, -1):
            ...
            self.dcn_pack[level] = DeformConv2d(num_feat, num_feat, 3,
                                                padding=1,
        ...
        self.cas_dcnpack = DeformConv2d(num_feat, num_feat, 3, padding=1,
                                        deformable_groups=deformable_groups)
    ...
    def forward(self, nbr_feat_l, ref_feat_l):
        ...
        for i in range(3, 0, -1):
            ...
            if i==3:
                ...
                offset = self.lrelu(self.offset_conv2[level](
            ...
            if i>1: # upsample offset and features
                # x2: when we upsample the offset, we should also enlarge the
                # magnitude
...
class TSAFusion(nn.Module):
    ...
    def forward(self, aligned_feat):
        ...
        attn = self.lrelu(sefl.spatial_attn2(torch.cat([attn_max, attn_avg], dim=1)))
        # pyramid levels
        ...
        # after init, * 2 makes (attn * 2) to be close to 1
...
class PredeblurModule(nn.Module):
    def __init__(self, num_in_ch=3, num_feat=64, hr_in=False):
        ...
        self.resblock_l1 = nn.ModuleList([ResidualBlockNoBN(num_feat=num_feat)
                                          for i in range(5)])
...
class EDVR(nn.Module):
    def __init__(self, num_in_ch=3, num_out_ch=3, num_feat=64, num_frame=5,
                 ...
                 num_reconstruct_block=10, center_frame_idx=None, hr_in=False,
        ...
        self.feature_extraction = make_layer(ResidualBlockNoBN, num_extract_block,
                                             num_feat=num_feat)
